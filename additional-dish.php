...
<head>
    ...
    <title>Ubersicht Station 1</title>
...
<div class="wrapper select-dish">
    ...
    <nav class="navbar navbar-expand navbar-light">
        ...
        <ul class="navbar-nav special-navbar-nav">
            <li class="nav-center"><h4 class="ml-5 nav-item-special">Ubersicht Station 1</h4></li>
        </ul>
    </nav>
    <!-- /.navbar -->
    ...
    <div class="custom-content-wrapper">
        ...
        <section class="content pt-3">
            <div class="container custom-container">
                <form method="POST" action="./additional-orders.php" id="meal_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="dish-col text-center">
                                    ...
                                    <p>Beef goulash with saetzle with red cabbage</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="dish-col">
                                    ...
                                    <p>Beef goulash with saetzle with red cabbage. Beef goulash with saetzle with red cabbage</p>
